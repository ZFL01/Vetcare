...
<div class="flex min-h-screen">
    ...
    <div class="flex-1 md:ml-64">
        <div class="bg-gradient-to-r from-purple-600 via-violet-600 to-fuchsia-600 shadow-lg fixed top-0 left-0 right-0 md:left-64 z-40">
            <div class="px-8 py-4">
    ...
    d="M12 4.75c-2.2 0-4 1.8-4 4s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4zm0 10c-3.7 0-7 2-7 4.5v.75c0 .6.4 1 1 1h12c.6 0 1-.4 1-1v-.75c0-2.5-3.3-4.5-7-4.5z"/>
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 mb-8">
                    <div class="text-center mb-8">
                        ...
                        <div class="w-24 h-1 bg-gradient-to-r from-purple-500 to-violet-600 mx-auto mt-4 rounded-full"></div>
                    </div>

                    <div class="relative">
                        <div class="w-full h-[600px] rounded-xl border-2 border-purple-200 overflow-hidden shadow-lg bg-gray-50">
                            <iframe
                                ...
                                loading="lazy"
                                style="zoom: 0.7;"></iframe>
                        </div>
                    </div>

                    <div class="mt-6 text-center">
                        <p class="text-gray-500 text-sm mb-4">
                            Dashboard Power BI menampilkan analisis lengkap sebaran lokasi, kategori Terpopuler, dan statistik kepuasan pelanggan.
                        </p>
                    </div>
                </div>
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr class="border-b-2 border-gray-200">
                                        <th class="px-6 py-4 text-left text-sm font-bold text-gray-700"> Nama Dokter</th>
