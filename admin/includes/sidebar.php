...
<div id="sidebar"
    class="w-64 bg-white/90 backdrop-blur-md border-r border-purple-300 min-h-screen p-5 shadow-md relative md:fixed z-30 transform md:translate-x-0 transition-transform duration-300 ease-in-out">
