...
class Database
{
    ...
    {
        // MENGGUNAKAN PERBANDINGAN PLAIN TEXT (TIDAK AMAN)
        $stmt = $this->pdo->prepare("SELECT id_pengguna, email, nama FROM m_pengguna WHERE email = ? AND pass = ?");
    ...
    // --- METODE RESET SAMA DENGAN VERSI AMAN, HANYA MENGGANTI KOLOM PENGGUNA ---
