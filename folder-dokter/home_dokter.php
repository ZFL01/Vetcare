...
<main class="flex-grow">
    ...
    <section class="bg-gradient-to-br from-primary to-secondary text-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="pages/dashboard-dokter.php" class="bg-white text-primary px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                    🏥 Dashboard
                </a>
                <a href="pages/tanya-dokter.php" class="bg-accent text-white px-8 py-3 rounded-lg font-semibold hover:bg-purple-400 transition-colors">
                    💬 Jawab Pertanyaan
                </a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-shadow">
                    ...
                    <a href="pages/dashboard-dokter.php" class="text-primary hover:text-secondary mt-4 inline-block">Lihat →</a>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-shadow">
                    <div class="text-4xl mb-4">💬</div>
                    ...
                    <a href="pages/tanya-dokter.php" class="text-primary hover:text-secondary mt-4 inline-block">Mulai →</a>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-shadow">
                    <div class="text-4xl mb-4">📝</div>
                    <h3 class="text-xl font-semibold mb-2 text-gray-800">Kelola Artikel</h3>
                    <p class="text-gray-600">Bagikan pengetahuan kesehatan</p>
                    <a href="pages/kelola-artikel.php" class="text-primary hover:text-secondary mt-4 inline-block">Kelola →</a>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl text-center hover:shadow-lg transition-shadow">
                    <div class="text-4xl mb-4">💭</div>
                    <h3 class="text-xl font-semibold mb-2 text-gray-800">Chat Pasien</h3>
                    <p class="text-gray-600">Komunikasi langsung dengan pasien</p>
                    <a href="pages/chat-pasien.php" class="text-primary hover:text-secondary mt-4 inline-block">Chat →</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-primary text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="pages/dashboard-dokter.php" class="bg-white text-primary px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-lg">
                Mulai Sekarang →
            </a>
        </div>
    </section>
