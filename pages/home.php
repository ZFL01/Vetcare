                ...
                <div
                    ...
                    <div class="relative z-10">
                        <div
                            ...
                            <!-- Glow Effect -->
                            <div
                                class="absolute inset-0 bg-gradient-indigo-violet rounded-3xl opacity-0 group-hover:opacity-30 blur-xl transition-opacity duration-500">
                            </div>
                        </div>
                        ...
                        <p class="text-gray-600 leading-relaxed text-lg mb-6">
                            Konsultasi online dengan dokter hewan profesional kapan saja, di mana saja. Dapatkan jawaban
                            cepat untuk pertanyaan kesehatan hewan Anda.
                    </div>
                </div>
            </a>
